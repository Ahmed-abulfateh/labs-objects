...
// Select a starter Pokémon (Bulbasaur in this case)
...
// Choose three more Pokémon
const morePokemon = pokemon.filter(p => 
  p.name === "Ivysaur" || p.name === "Venusaur" || p.name === "Charmander"
);
...
// Choose all Fire-type Pokémon
const firePokemon = pokemon.filter(p => p.type === "fire");
...
*/
// Filter the array to get only starter Pokémon
const pokemstarter = pokemon.filter(p => p.starter);

// Loop through and log their names
...
*/
// Add the catchPokemon method to the game object
game.catchPokemon = function(pokemonObj) {
  this.party.push(pokemonObj);
};

// Example: Catch Venusaur from the pokemon array
const venusaur = pokemon.find(p => p.name === "Venusaur");

// Call the method to add Venusaur to the party
...
// Add the updated catchPokemon method to the game object
game.catchPokemon = function(pokemonObj) {
  // Add the Pokémon to the party
  this.party.push(pokemonObj);

  // Find the pokeball item in the inventory
...
// Example: Catch Charmeleon from the pokemon array
const charmeleon = pokemon.find(p => p.name === "Charmeleon");

// Call the method to add Charmeleon to the party
game.catchPokemon(charmeleon);

// Log the party and items to confirm changes
console.log(game.party);
...
*/
// Add the gymStatus method to the game object
...
// Call the method to see the tally
game.gymStatus();
...
*/
// Add the partyCount method to the game object
...
// Simply log the entire game object
console.log(game)}